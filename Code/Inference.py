...
def main(paragraph ,questions , model = "model/pytorch_model.bin" , max_seq_length = 384 ,doc_stride = 128,max_query_length=64 ,config_file = "Results/bert_config.json" , max_answer_length = 30  ):
